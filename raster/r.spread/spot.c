 ...
 *        ententions of equations for pocket calculators, US Forest Service,
 *        Res. Note INT-346, Ogden, Uhta, 27 p.
...
void spot(struct costHa *pres_cell, int dir /* direction of forward ROS */)
{
    ...
    G_debug(1,
            "        pre pick_ignite(): land_distc(%d, %d)=%d dir=%d PI=%.2f "
            "(dir%%360)*PI/180=%.2f",
    ...
    G_debug(1, "        post pick_ignite(): land_distc(%d, %d)=%d ", row, col,
            land_distc);
