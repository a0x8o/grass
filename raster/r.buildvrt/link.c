...
void make_link(const struct input *inputs, int num_inputs, const char *output)
{
    int i;
    FILE *fp;
...
void write_fp_format(const char *output, int maptype)
{
    ...
    type = (maptype == FCELL_TYPE) ? "float" : "double";
...
>>>>>>> 033e7a3234 (wxpyimgview: explicit conversion to int (#2704))
{
    ...
    Rast_format_history(&history, HIST_KEYWRD,
                        _("virtual raster generated by %s"), G_program_name());
