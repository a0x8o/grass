...
>>>>>>> 6e838855e2 (wxpyimgview: explicit conversion to int (#2704))
    ...
    int useLzw;      /* RASTER3D_USE_LZW or RASTER3D_NO_LZW !!! only kept for
                        backward compatibility */
    int useRle;      /* RASTER3D_USE_RLE or RASTER3D_NO_RLE !!! only kept for
                        backward compatibility */
    int useXdr;      /* RASTER3D_USE_XDR or RASTER3D_NO_XDR !!! only kept for
                        backward compatibility */
