...
/* mult.c */
extern int G_math_complex_mult(double *v1[2], int size1, double *v2[2],
                               int size2, double *v3[2], int size3);
...
extern G_math_spvector **G_math_sband_matrix_to_Asp(double **, int, int,
                                                    double);
...
extern void G_math_Ax_sband(double **A, double *x, double *y, int rows,
                            int bandwidth);
...
extern void G_math_d_aAx_by(double **, double *, double *, double, double,
                            double *, int, int);
extern void G_math_f_aAx_by(float **, float *, float *, float, float, float *,
                            int, int);
