...
=======
>>>>>>> d84037d8e2 (CI(deps): Update docker/dockerfile Docker tag to v1.8 (#3797))
=======
...
=======
>>>>>>> e72ef72931 (CI(deps): Update docker/dockerfile Docker tag to v1.8 (#3797))
=======
...
LABEL authors="Carmen Tawalika,Markus Neteler,Anika Weinmann"
>>>>>>> 53e8a80f56 (CI(deps): Update docker/dockerfile Docker tag to v1.8 (#3797))
=======
=======
>>>>>>> 04de8c7cca (wxpyimgview: explicit conversion to int (#2704))
=======
...
>>>>>>> b59427ac06 (docker: Use only native Python API, set only necessary variables (#3819))
=======
>>>>>>> f4fbd3ec63 (docker: Revert failing cleaning steps in Ubuntu Dockerfile (#3830))
=======
