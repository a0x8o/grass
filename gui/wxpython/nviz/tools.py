...
class NvizToolWindow(GNotebook):
    ...
    def _createSurfacePage(self, parent):
        ...
        gridSizer.Add(resC, pos=(2, 2), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        ...
        # color
        color = ColourSelect(panel, id=wx.ID_ANY, size=globalvar.DIALOG_COLOR_SIZE)
        ...
        gridSizer.Add(color, flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT, pos=(3, 3))
        ...
        resF = SpinCtrl(
            parent=panel, id=wx.ID_ANY, size=(65, -1), initial=3, min=1, max=100
        )
        resF.SetName("value")
        self.win["surface"]["draw"]["res-fine"] = resF.GetId()
        resF.Bind(wx.EVT_SPINCTRL, self.OnSurfaceResolution)
        gridSizer.Add(resF, pos=(1, 2), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        ...
        #
        box = StaticBox(
            parent=panel, id=wx.ID_ANY, label=" %s " % (_("Surface attributes"))
        )
        boxSizer = wx.StaticBoxSizer(box, wx.VERTICAL)
        gridSizer = wx.GridBagSizer(vgap=3, hgap=3)
        ...
        for code, attrb in (
            ...
            gridSizer.Add(
                StaticText(parent=panel, id=wx.ID_ANY, label=attrb + ":"),
                pos=(row, 0),
                flag=wx.ALIGN_CENTER_VERTICAL,
            )
            use = wx.Choice(
            ...
            gridSizer.Add(use, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 1))
            ...
            gridSizer.Add(map, flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, pos=(row, 2))

            if code == "color":
                color = UserSettings.Get(
                    group="nviz", key="surface", subkey=["color", "value"]
                )
                value = csel.ColourSelect(
                    panel, id=wx.ID_ANY, colour=color, size=globalvar.DIALOG_COLOR_SIZE
                )
                value.Bind(csel.EVT_COLOURSELECT, self.OnSurfaceMap)
            elif code == "mask":
                value = None
            else:
                value = SpinCtrl(parent=panel, id=wx.ID_ANY, size=(65, -1), initial=0)
            ...
            if value:
                ...
                value.Enable(False)
                gridSizer.Add(value, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 3))
            else:
        ...
        boxSizer.Add(gridSizer, proportion=0, flag=wx.ALL | wx.EXPAND, border=3)
        pageSizer.Add(boxSizer, proportion=0, flag=wx.EXPAND | wx.ALL, border=3)
        #
        # position
        #
        ...
        axis = wx.Choice(
            parent=panel, id=wx.ID_ANY, size=(75, -1), choices=["X", "Y", "Z"]
        )
    ...
    def _createCPlanePage(self, parent):
        ...
        pageSizer = wx.BoxSizer(wx.VERTICAL)
        box = StaticBox(
            parent=panel, id=wx.ID_ANY, label=" %s " % (_("Cutting planes"))
        )
        boxSizer = wx.StaticBoxSizer(box, wx.VERTICAL)
        ...
        # planes
        horSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Active cutting plane:")),
        ...
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Horizontal X:")),
            pos=(0, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        gridSizer.Add(
            self.FindWindowById(self.win["cplane"]["position"]["x"]["text"]),
            pos=(0, 2),
            flag=wx.ALIGN_CENTER,
        )
        ...
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Horizontal Y:")),
            pos=(1, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        gridSizer.Add(
            self.FindWindowById(self.win["cplane"]["position"]["y"]["slider"]),
            pos=(1, 1),
            flag=wx.EXPAND | wx.ALIGN_RIGHT,
        )
        gridSizer.Add(
            self.FindWindowById(self.win["cplane"]["position"]["y"]["text"]),
            pos=(1, 2),
            flag=wx.ALIGN_CENTER,
        )
        ...
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Rotation:")),
            pos=(2, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        self.FindWindowById(self.win["cplane"]["rotation"]["rot"]["slider"]).SetValue(
            180
        )
        self.FindWindowById(self.win["cplane"]["rotation"]["rot"]["text"]).SetValue(180)
        gridSizer.Add(
            self.FindWindowById(self.win["cplane"]["rotation"]["rot"]["slider"]),
            pos=(2, 1),
            flag=wx.EXPAND | wx.ALIGN_RIGHT,
        )
        gridSizer.Add(
            self.FindWindowById(self.win["cplane"]["rotation"]["rot"]["text"]),
            pos=(2, 2),
            flag=wx.ALIGN_CENTER,
        )
        ...
        # cutting plane tilt
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Tilt:")),
            pos=(3, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        self.FindWindowById(self.win["cplane"]["rotation"]["tilt"]["slider"]).SetValue(
            0
        )
        self.FindWindowById(self.win["cplane"]["rotation"]["tilt"]["text"]).SetValue(0)
        gridSizer.Add(
            self.FindWindowById(self.win["cplane"]["rotation"]["tilt"]["slider"]),
            pos=(3, 1),
            flag=wx.EXPAND | wx.ALIGN_RIGHT,
        )
        gridSizer.Add(
            self.FindWindowById(self.win["cplane"]["rotation"]["tilt"]["text"]),
            pos=(3, 2),
            flag=wx.ALIGN_CENTER,
        )
        ...
        gridSizer.Add(
            self.FindWindowById(self.win["cplane"]["position"]["z"]["slider"]),
            pos=(4, 1),
            flag=wx.EXPAND | wx.ALIGN_RIGHT,
        )
        gridSizer.Add(
    ...
    def _createConstantPage(self, parent):
        ...
        box = StaticBox(
            parent=panel, id=wx.ID_ANY, label=" %s " % (_("Constant surface"))
        )
        boxSizer = wx.StaticBoxSizer(box, wx.VERTICAL)
        horsizer = wx.BoxSizer(wx.HORIZONTAL)

        surface = wx.ComboBox(
            parent=panel, id=wx.ID_ANY, style=wx.CB_SIMPLE | wx.CB_READONLY, choices=[]
        )
        ...
        horsizer.Add(addNew, proportion=0, flag=wx.RIGHT | wx.LEFT, border=3)
        horsizer.Add(delete, proportion=0, flag=wx.RIGHT | wx.LEFT, border=3)

        boxSizer.Add(horsizer, proportion=0, flag=wx.ALL | wx.EXPAND, border=5)

        gridSizer = wx.GridBagSizer(hgap=5, vgap=5)
        # fine resolution
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Fine resolution:")),
            pos=(0, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        resF = SpinCtrl(
        ...
        gridSizer.Add(resF, pos=(0, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        # value
        gridSizer.Add(
        ...
        value = SpinCtrl(panel, id=wx.ID_ANY, min=-1e9, max=1e9, size=(65, -1))
        ...
        # transparency
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Transparency:")),
            pos=(2, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )

        transp = SpinCtrl(panel, id=wx.ID_ANY, min=0, max=100, size=(65, -1))
        ...
        color = csel.ColourSelect(
            panel, id=wx.ID_ANY, colour=(0, 0, 0), size=globalvar.DIALOG_COLOR_SIZE
        )
        self.win["constant"]["color"] = color.GetId()
        color.Bind(csel.EVT_COLOURSELECT, self.OnSetConstantProp)
        gridSizer.Add(color, pos=(3, 1))
        boxSizer.Add(gridSizer, proportion=0, flag=wx.ALL, border=5)
        pageSizer.Add(boxSizer, proportion=0, flag=wx.EXPAND | wx.ALL, border=3)
    ...
    def _createVectorPage(self, parent):
        ...
        # selection
        box = StaticBox(parent=panel, id=wx.ID_ANY, label=" %s " % (_("Vector map")))
        boxSizer = wx.StaticBoxSizer(box, wx.VERTICAL)
        vmaps = Select(parent=panel, type="vector", onPopup=self.GselectOnPopup)
        vmaps.GetChildren()[0].Bind(wx.EVT_TEXT, self.OnSetVector)
        self.win["vector"]["map"] = vmaps.GetId()
        desc = StaticText(parent=panel, id=wx.ID_ANY)
        self.win["vector"]["desc"] = desc.GetId()
        boxSizer.Add(vmaps, proportion=0, flag=wx.ALL, border=3)
        boxSizer.Add(desc, proportion=0, flag=wx.ALL, border=3)
        pageSizer.Add(
            boxSizer,
            proportion=0,
        ...
        showLines = wx.CheckBox(
            parent=panel, id=wx.ID_ANY, label=_("Show vector lines")
        )
        ...
        # width
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Line:")),
            pos=(0, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        gridSizer.Add(
        ...
        width = SpinCtrl(
            parent=panel, id=wx.ID_ANY, size=(65, -1), initial=1, min=1, max=100
        )
        width.SetValue(1)
        self.win["vector"]["lines"]["width"] = width.GetId()
        width.Bind(wx.EVT_SPINCTRL, self.OnVectorLines)
        gridSizer.Add(width, pos=(0, 2), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT)
        ...
        gridSizer.Add(color, pos=(0, 4), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT)

        # thematic mapping
        self.win["vector"]["lines"]["thematic"] = {}
        checkThematicColor = wx.CheckBox(
            parent=panel, id=wx.ID_ANY, label=_("use color for thematic mapping")
        )
        ...
        hSizer = wx.BoxSizer(wx.HORIZONTAL)
        hSizer.Add(checkThematicColor, flag=wx.ALIGN_CENTER_VERTICAL, border=5)
        setThematic = Button(parent=panel, id=wx.ID_ANY, label=_("Set options..."))
        ...
        hSizer.Add(
            setThematic, flag=wx.ALIGN_CENTER_VERTICAL | wx.LEFT, border=5, proportion=0
        )
        vSizer.Add(hSizer, flag=wx.EXPAND)

        hSizer = wx.BoxSizer(wx.HORIZONTAL)
        hSizer.Add(checkThematicWidth, flag=wx.ALIGN_CENTER_VERTICAL, border=5)
        setThematic = Button(parent=panel, id=wx.ID_ANY, label=_("Set options..."))
        ...
        vSizer.Add(hSizer, flag=wx.EXPAND)
        gridSizer.Add(
            vSizer, flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, pos=(1, 1), span=(1, 5)
        )
        ...
        display = wx.Choice(
            ...
            id=wx.ID_ANY,
            size=(-1, -1),
            choices=[_("on surface(s):"), _("as 3D")],
        )
        ...
        # height
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Height above surface:")),
            pos=(3, 5),
            flag=wx.ALIGN_BOTTOM | wx.EXPAND,
        )

        surface = CheckListBox(
            parent=panel, id=wx.ID_ANY, size=(-1, 60), choices=[], style=wx.LB_NEEDED_SB
        )
        surface.Bind(wx.EVT_CHECKLISTBOX, self.OnVectorSurface)

        self.win["vector"]["lines"]["surface"] = surface.GetId()
        gridSizer.Add(
            surface, pos=(3, 0), span=(3, 5), flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND
        )
        ...
        gridSizer.Add(
            self.FindWindowById(self.win["vector"]["lines"]["height"]["slider"]),
            pos=(4, 5),
            flag=wx.EXPAND | wx.ALIGN_RIGHT,
        )
        gridSizer.Add(
            self.FindWindowById(self.win["vector"]["lines"]["height"]["text"]),
            pos=(5, 5),
            flag=wx.ALIGN_CENTER,
        )
        ...
        showPoints = wx.CheckBox(
            parent=panel, id=wx.ID_ANY, label=_("Show vector points")
        )
        ...
        # icon size
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Icon:")),
            pos=(0, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        gridSizer.Add(
        ...
        if fs:
            ...
            isize = SpinCtrl(
                parent=panel, id=wx.ID_ANY, size=(65, -1), initial=1, min=1, max=1e6
            )
            isize.Bind(wx.EVT_SPINCTRL, self.OnVectorPoints)
        isize.SetName("value")
        isize.SetValue(100)
        self.win["vector"]["points"]["size"] = isize.GetId()
        gridSizer.Add(isize, pos=(0, 2), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT)
        ...
        gridSizer.Add(isym, flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT, pos=(0, 6))
        # thematic mapping
        ...
        setThematic.Bind(wx.EVT_BUTTON, self.OnSetThematic)
        gridSizer.Add(setThematic, flag=wx.ALIGN_CENTER_VERTICAL, pos=(1, 6))
        ...
        setThematic.Bind(wx.EVT_BUTTON, self.OnSetThematic)
        gridSizer.Add(setThematic, flag=wx.ALIGN_CENTER_VERTICAL, pos=(2, 6))
        gridSizer.AddGrowableCol(0)
        gridSizer.AddGrowableCol(2)
        ...
        gridSizer = wx.GridBagSizer(vgap=5, hgap=5)
        gridSizer.Add(
            StaticText(parent=panel, label=_("Display")),
            pos=(0, 0),
            flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT,
        )
        ...
        gridSizer.Add(display, pos=(0, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND)
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Height above surface:")),
            pos=(1, 2),
            flag=wx.ALIGN_CENTER_VERTICAL,
        ...
        gridSizer.Add(
            surface, pos=(1, 0), span=(3, 2), flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND
        )
        ...
        self.FindWindowById(self.win["vector"]["points"]["height"]["slider"]).SetValue(
            0
        )
        self.FindWindowById(self.win["vector"]["points"]["height"]["text"]).SetValue(0)

        gridSizer.Add(
            self.FindWindowById(self.win["vector"]["points"]["height"]["slider"]),
            pos=(2, 2),
            flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        gridSizer.Add(
            self.FindWindowById(self.win["vector"]["points"]["height"]["text"]),
            pos=(3, 2),
            flag=wx.ALIGN_CENTER,
        )
        gridSizer.AddGrowableCol(2)
        ...
        vertSizer.Add(gridSizer, proportion=0, flag=wx.EXPAND, border=0)
        boxSizer.Add(vertSizer, proportion=1, flag=wx.ALL | wx.EXPAND, border=3)
        pageSizer.Add(
            boxSizer,
            proportion=0,
            flag=wx.EXPAND | wx.LEFT | wx.RIGHT | wx.BOTTOM,
    ...
    def _createVolumePage(self, parent):
        ...
        # selection
        box = StaticBox(parent=panel, id=wx.ID_ANY, label=" %s " % (_("3D raster map")))
        boxSizer = wx.StaticBoxSizer(box, wx.VERTICAL)
        rmaps = Select(parent=panel, type="raster_3d", onPopup=self.GselectOnPopup)
        ...
        mode = wx.Choice(
            ...
            id=wx.ID_ANY,
            size=(-1, -1),
            choices=[_("isosurfaces"), _("slices")],
        )
        mode.SetSelection(0)
        mode.SetName("selection")
        ...
        # draw wire box
        box = wx.CheckBox(parent=panel, id=wx.ID_ANY, label=_("Draw wire box"))
        box.SetName("value")
        ...
        #
        box = StaticBox(
            parent=panel, id=wx.ID_ANY, label=" %s " % (_("List of isosurfaces"))
        )
        ...
        # list
        isolevel = CheckListBox(parent=panel, id=wx.ID_ANY, size=(300, 150))
        ...
        gridSizer.Add(btnDelete, pos=(1, 1))
        ...
        gridSizer.Add(btnMoveUp, pos=(2, 1))
        ...
        gridSizer.Add(btnMoveDown, pos=(3, 1))
        ...
        pageSizer.Add(sizer, proportion=0, flag=wx.EXPAND | wx.ALL, border=3)
        #
        # position
        #
    ...
    def _createLightPage(self, parent):
        ...
        show = wx.CheckBox(parent=panel, id=wx.ID_ANY, label=_("Show light model"))
        show.Bind(wx.EVT_CHECKBOX, self.OnShowLightModel)
        show.SetValue(True)
        self._display.showLight = True
        pageSizer.Add(show, proportion=0, flag=wx.ALL, border=3)
        ...
        # position
        box = StaticBox(
            parent=panel, id=wx.ID_ANY, label=" %s " % (_("Light source position"))
        )
        boxSizer = wx.StaticBoxSizer(box, wx.VERTICAL)
        ...
        pos = LightPositionWindow(
            panel, id=wx.ID_ANY, size=(175, 175), mapwindow=self.mapWindow
        )
        self.win["light"]["position"] = pos.GetId()
        posSizer.Add(pos, pos=(1, 1), flag=wx.ALIGN_CENTER | wx.ALIGN_CENTER_VERTICAL)
        gridSizer.Add(posSizer, pos=(0, 0))
        ...
        heightSizer.Add(
            self.FindWindowById(self.win["light"]["z"]["slider"]),
            flag=wx.ALIGN_RIGHT,
            pos=(1, 0),
        )
        heightSizer.Add(
            self.FindWindowById(self.win["light"]["z"]["text"]),
            flag=wx.ALIGN_CENTER_VERTICAL
            | wx.ALIGN_LEFT
            | wx.TOP
            | wx.BOTTOM
        ...
        # position
        box = StaticBox(
            parent=panel, id=wx.ID_ANY, label=" %s " % (_("Light color and intensity"))
        )
        boxSizer = wx.StaticBoxSizer(box, wx.VERTICAL)
        gridSizer = wx.GridBagSizer(vgap=3, hgap=3)

        gridSizer.Add(
            StaticText(panel, id=wx.ID_ANY, label=_("Color:")),
            pos=(0, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        color = csel.ColourSelect(
        ...
        gridSizer.Add(
            StaticText(panel, id=wx.ID_ANY, label=_("Brightness:")),
            pos=(1, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        gridSizer.Add(
            self.FindWindowById(self.win["light"]["bright"]["slider"]),
            pos=(1, 1),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        gridSizer.Add(
            self.FindWindowById(self.win["light"]["bright"]["text"]),
            pos=(1, 2),
            flag=wx.ALIGN_CENTER,
        )
        gridSizer.Add(
            StaticText(panel, id=wx.ID_ANY, label=_("Ambient:")),
            pos=(2, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        gridSizer.Add(
            self.FindWindowById(self.win["light"]["ambient"]["slider"]),
            pos=(2, 1),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        gridSizer.Add(
    ...
    def _createFringePage(self, parent):
        ...
        # selection
        rbox = StaticBox(parent=panel, id=wx.ID_ANY, label=" %s " % (_("Surface")))
        ...
        rboxSizer.Add(rmaps, proportion=0, flag=wx.ALL, border=3)
        pageSizer.Add(
            rboxSizer,
            proportion=0,
            flag=wx.EXPAND | wx.LEFT | wx.RIGHT | wx.BOTTOM,
        ...
        ebox = StaticBox(
            parent=panel, id=wx.ID_ANY, label=" %s " % (_("Edges with fringe"))
        )
        ...
        for edge in [
            ...
            chkbox = wx.CheckBox(parent=panel, label=edge[0], name=edge[1])
        ...
        sbox = StaticBox(parent=panel, id=wx.ID_ANY, label=" %s " % (_("Settings")))
        ...
        gridSizer.Add(
            StaticText(
                parent=panel, id=wx.ID_ANY, label=_("Elevation of fringe from bottom:")
            ),
            pos=(0, 0),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        spin = SpinCtrl(parent=panel, id=wx.ID_ANY, size=(65, -1), min=-1e6, max=1e6)
        ...
        color = csel.ColourSelect(
            parent=panel, id=wx.ID_ANY, size=globalvar.DIALOG_COLOR_SIZE
        )
        color.SetColour(UserSettings.Get(group="nviz", key="fringe", subkey="color"))
        color.Bind(csel.EVT_COLOURSELECT, self.OnFringe)
        self.win["fringe"]["color"] = color.GetId()
        gridSizer.Add(color, pos=(1, 1))

        sboxSizer.Add(gridSizer, proportion=1, flag=wx.ALL | wx.EXPAND, border=3)
        pageSizer.Add(
            sboxSizer,
            proportion=0,
            flag=wx.EXPAND | wx.LEFT | wx.RIGHT | wx.BOTTOM,
    ...
    def _createDecorationPage(self, parent):
        ...
        nabox = StaticBox(parent=panel, id=wx.ID_ANY, label=" %s " % (_("North Arrow")))
        naboxSizer = wx.StaticBoxSizer(nabox, wx.VERTICAL)
        gridSizer = wx.GridBagSizer(hgap=5, vgap=5)
        # size
        gridSizer.Add(
            StaticText(
                parent=panel, id=wx.ID_ANY, label=_("Arrow length (in map units):")
            ),
            pos=(0, 0),
            span=(1, 2),
            flag=wx.ALIGN_CENTER_VERTICAL,
        ...
        sizeCtrl = NumTextCtrl(
            parent=panel, id=wx.ID_ANY, size=(65, -1), style=wx.TE_PROCESS_ENTER
        )
        ...
        # color
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Arrow color:")),
            pos=(1, 0),
            span=(1, 2),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        # control
        toggle = ToggleButton(parent=panel, id=wx.ID_ANY, label=_("Place arrow"))
        ...
        nabox = StaticBox(parent=panel, id=wx.ID_ANY, label=" %s " % (_("Scale bar")))
        naboxSizer = wx.StaticBoxSizer(nabox, wx.VERTICAL)
        gridSizer = wx.GridBagSizer(hgap=5, vgap=5)
        # size
        gridSizer.Add(
            StaticText(
                parent=panel, id=wx.ID_ANY, label=_("Scale bar length (in map units):")
            ),
            pos=(0, 0),
            span=(1, 2),
            flag=wx.ALIGN_CENTER_VERTICAL,
        ...
        # color
        gridSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Scale bar color:")),
            pos=(1, 0),
            span=(1, 2),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        # control
        toggle = ToggleButton(
            parent=panel, id=wx.ID_ANY, label=_("Place new scale bar")
        )
        gridSizer.Add(toggle, pos=(2, 0))
        toggle.Bind(wx.EVT_TOGGLEBUTTON, self.OnDecorationPlacement)
    ...
    def UpdateFrameIndex(
        self, index, sliderWidget=True, textWidget=True, goToFrame=True
    ):
        """Update frame index"""
        anim = self.mapWindow.GetAnimation()
    ...
    def OnSaveAnimation(self, event):
        ...
        prefix = self.FindWindowById(
            self.win["anim"]["save"]["image"]["prefix"]
        ).GetValue()
        format = self.FindWindowById(
            self.win["anim"]["save"]["image"]["format"]
        ).GetSelection()
    ...
    def _createIsosurfacePanel(self, parent):
        ...
        box = StaticBox(
            parent=panel, id=wx.ID_ANY, label=" %s " % (_("Isosurface attributes"))
        )
        boxSizer = wx.StaticBoxSizer(box, wx.VERTICAL)
        gridSizer = wx.GridBagSizer(vgap=3, hgap=3)
        ...
        inout = wx.CheckBox(
            parent=panel, id=wx.ID_ANY, label=_("toggle normal direction")
        )
        gridSizer.Add(inout, pos=(0, 0), span=(1, 2), flag=wx.ALIGN_CENTER_VERTICAL)
        inout.Bind(wx.EVT_CHECKBOX, self.OnInOutMode)
        self.win["volume"]["inout"] = inout.GetId()

        row = 1
        for code, attrb in (
            ("topo", _("Isosurface value")),
            ("color", _("Color")),
            ("mask", _("Mask")),
            ("transp", _("Transparency")),
            ("shine", _("Shininess")),
            ...
            if code != "topo":
                ...
                gridSizer.Add(map, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 2))
            else:
                map = None

            if code == "color":
                color = UserSettings.Get(
                    group="nviz", key="volume", subkey=["color", "value"]
                )
                value = csel.ColourSelect(
                    panel, id=wx.ID_ANY, colour=color, size=globalvar.DIALOG_COLOR_SIZE
                )
            ...
            if value:
                ...
                if code == "topo":
                    gridSizer.Add(value, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 2))
                else:
                    value.Enable(False)
                    gridSizer.Add(value, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 3))
            else:
        ...
        boxSizer.Add(gridSizer, proportion=1, flag=wx.ALL | wx.EXPAND, border=3)
        vSizer.Add(boxSizer, proportion=1, flag=wx.EXPAND, border=0)
    ...
    def _createSlicePanel(self, parent):
        ...
        hSizer.Add(
            StaticText(parent=panel, id=wx.ID_ANY, label=_("Slice parallel to axis:")),
            proportion=0,
            flag=wx.ALIGN_CENTER_VERTICAL | wx.RIGHT,
            border=3,
        )
        axes = wx.Choice(
            parent=panel, id=wx.ID_ANY, size=(65, -1), choices=("X", "Y", "Z")
        )
        ...
        for i in range(2):
            ...
            gridSizer.Add(label, pos=(0, i + 1), flag=wx.ALIGN_CENTER)
        for i in range(2, 4):
            label = StaticText(parent=panel, id=wx.ID_ANY)
            label.SetName("label_edge_" + str(i))
            gridSizer.Add(label, pos=(3, i - 1), flag=wx.ALIGN_CENTER)
        for i in range(2):
            label = StaticText(parent=panel, id=wx.ID_ANY)
            label.SetName("label_coord_" + str(i))
            gridSizer.Add(label, pos=(i + 1, 0), flag=wx.ALIGN_CENTER_VERTICAL)
        label = StaticText(parent=panel, id=wx.ID_ANY)
        ...
        for i, coord in enumerate(("z1", "z2")):
            ...
            slider.Bind(wx.EVT_SPIN, self.OnSlicePositionChange)
            slider.Bind(wx.EVT_SCROLL_THUMBRELEASE, self.OnSlicePositionChanged)
            gridSizer.Add(slider, pos=(4, i + 1), flag=wx.ALIGN_CENTER | wx.EXPAND)
        ...
        spin = SpinCtrl(
            parent=panel, id=wx.ID_ANY, size=(65, -1), min=0, max=100, initial=0
        )
        ...
        hSizer.Add(wx.Size(-1, -1), proportion=1, flag=wx.EXPAND)
        reset = Button(parent=panel, id=wx.ID_ANY, label=_("Reset"))
        reset.Bind(wx.EVT_BUTTON, self.OnSliceReset)
        self.win["volume"]["slice"]["reset"] = reset.GetId()
        hSizer.Add(
            reset, proportion=0, flag=wx.ALIGN_CENTER_VERTICAL | wx.TOP, border=7
        )
...
>>>>>>> 4217d7b0d6 (wxpyimgview: explicit conversion to int (#2704))
        ...
        text = NumTextCtrl(
            parent=parent, id=wx.ID_ANY, size=(65, -1), style=wx.TE_PROCESS_ENTER
        )
    ...
    def UpdateSettings(self):
        ...
        x, y = viewWin.UpdatePos(
            self.mapWindow.view["position"]["x"], self.mapWindow.view["position"]["y"]
        )
...
>>>>>>> 6bd0f720cb (style(gui): Fixes literal-membership (PLR6201) (#3952))
    ...
    def OnLookFrom(self, event):
        ...
        if type == "view":
            ...
            x, y = lightWin.UpdatePos(
                self.mapWindow.light["position"]["x"],
        ...
        if selection == 0:  # unset
            ...
            if attrb == "color":
                value = self.FindWindowById(
                    self.win[nvizType][attrb]["const"]
                ).GetColour()
                value = self._getColorString(value)
            else:
                value = self._getPercent(
                    self.FindWindowById(self.win[nvizType][attrb]["const"]).GetValue(),
                    toPercent=False,
                )

        self.SetMapObjUseMap(nvizType=nvizType, attrb=attrb, map=useMap)

        name = self.FindWindowById(self.win[nvizType]["map"]).GetValue()
        if nvizType == "surface":
            data = self._getLayerPropertiesByName(name, mapType="raster")
            data[nvizType]["attribute"][attrb] = {
                "map": useMap,
                "value": str(value),
                "update": None,
            }
...
>>>>>>> 6bd0f720cb (style(gui): Fixes literal-membership (PLR6201) (#3952))
        ...
        if map is True:  # map
            ...
            self.FindWindowById(self.win[nvizType][attrb]["use"]).SetSelection(
                1 + incSel
            )
    ...
    def OnSurfaceMode(self, event):
        ...
        data = self.GetLayerData("surface")
        data["surface"]["draw"]["mode"] = {"value": value, "desc": desc, "update": None}
    ...
    def OnSurfaceModeAll(self, event):
        ...
        color = self.FindWindowById(
            self.win["surface"]["draw"]["wire-color"]
        ).GetColour()
        ...
        for name in self.mapWindow.GetLayerNames(type="raster"):
            ...
            data["surface"]["draw"]["wire-color"] = {"value": cvalue, "update": None}
    ...
    def OnSurfaceWireColor(self, event):
        ...
        data["surface"]["draw"]["wire-color"] = {"value": value, "update": None}
    ...
    def OnVectorLinesMode(self, event):
        ...
        if event.GetSelection() == 0:  # surface
            if len(rasters) < 1:
                self.FindWindowById(self.win["vector"]["lines"]["surface"]).Enable(
                    False
                )
    ...
    def OnVectorPointsMode(self, event):
        ...
        if event.GetSelection() == 0:  # surface
            if len(rasters) < 1:
                self.FindWindowById(self.win["vector"]["points"]["surface"]).Enable(
                    False
                )
            ...
            self.FindWindowById(
                self.win["vector"]["points"]["surface"]
            ).SetStringSelection(rasters[0])
    ...
    def OnVectorHeight(self, event):
        ...
        data = self.GetLayerData("vector")
        data["vector"][vtype]["height"] = {"value": value, "update": None}
    ...
    def OnVectorSurface(self, event):
        ...
        data = self.GetLayerData("vector")
        data["vector"][vtype]["mode"]["surface"] = {"value": surfaces, "show": checked}
            ...
            if attrType == "color":
                ...
                if not data["vector"][vtype]["thematic"]["rgbcolumn"]:
                    try:
                        ...
                        if self.HasGRASSRGB(name) and not self._display.CheckColorTable(
                            id=id, type=vtype
                        ):
    ...
    def OnVolumeCheck(self, event):
        ...
        if mode == "isosurf":
            if list.IsChecked(index):
                if (
                    "transp" in data["isosurface"][id]
                    and data["isosurface"][id]["transp"]["map"] is not None
                ):
    ...
    def OnVolumeAdd(self, event):
        ...
        if mode == "isosurf":
            ...
            if sel < 0 or sel >= list.GetCount() - 1:
                ...
                list.Insert(
                    item=_("Level {level}").format(level=level), pos=sel + 1
                )  # append
                item = sel + 1
        else:
            ...
            if sel < 0 or sel >= list.GetCount() - 1:
                ...
                list.Insert(
                    item=_("Slice parallel to {axis}").format(axis=axis), pos=sel + 1
                )  # append
                item = sel + 1
    ...
    def OnSliceTransparency(self, event):
        ...
        data["volume"]["slice"][sel]["transp"]["value"] = self._getPercent(
            val, toPercent=False
        )
    ...
    def OnCPlaneChanging(self, event):
        ...
        if event.GetId() in (
            list(self.win["cplane"]["rotation"]["rot"].values())
    ...
    def OnCPlaneReset(self, event):
        ...
        event = wxUpdateCPlane(
            update=("position", "rotation", "shading"), current=planeIndex
        )
        wx.PostEvent(self.mapWindow, event)
        self.OnCPlaneChangeDone(None)
        self.UpdateCPlanePage(planeIndex)
    ...
    def OnScalebarDelete(self, event):
        ...
        self.FindWindowById(self.win["decoration"]["scalebar"]["choice"]).Delete(
            choiceIndex
        )
    ...
    def DisableScalebarControls(self):
        choice = self.FindWindowById(self.win["decoration"]["scalebar"]["choice"])
        self.FindWindowById(self.win["decoration"]["scalebar"]["delete"]).Enable(
            not choice.IsEmpty()
        )
        self.FindWindowById(self.win["decoration"]["scalebar"]["choice"]).Enable(
            not choice.IsEmpty()
        )
    ...
    def UpdatePage(self, pageId):
        ...
        if pageId == "view":
            ...
            for control in ("slider", "text"):
                ...
                self.FindWindowById(self.win["light"]["ambient"][control]).SetValue(
                    aval
                )
            self.FindWindowById(self.win["light"]["color"]).SetColour(
            ...
            if xyRange > 0:  # GTK warning
                self.FindWindowById(
                    self.win["cplane"]["position"]["x"]["slider"]
                ).SetRange(-xyRange / 2.0, xyRange / 2.0)
                self.FindWindowById(
                    self.win["cplane"]["position"]["y"]["slider"]
                ).SetRange(-xyRange / 2.0, xyRange / 2.0)
            if zRange[1] - zRange[0] > 1:
                self.FindWindowById(
                    self.win["cplane"]["position"]["z"]["slider"]
                ).SetRange(zRange[0], zRange[1])
            self.FindWindowById(self.win["cplane"]["position"]["z"]["slider"]).SetValue(
                zRange[0]
            )
            self.FindWindowById(self.win["cplane"]["position"]["z"]["text"]).SetValue(
                zRange[0]
            )
    ...
    def UpdateCPlanePage(self, index):
        ...
        for widget in ("text", "slider"):
            for axes in ("x", "y", "z"):
                self.FindWindowById(
                    self.win["cplane"]["position"][axes][widget]
                ).SetValue(data["position"][axes])
            for each in ("tilt", "rot"):
                self.FindWindowById(
                    self.win["cplane"]["rotation"][each][widget]
                ).SetValue(data["rotation"][each])
    ...
    def UpdateSurfacePage(self, layer, data, updateName=True):
        ...
        self.SetMapObjUseMap(nvizType="surface", attrb="color", map=True)  # -> map
        ...
        if "color" in data["attribute"]:
            ...
            if data["attribute"]["color"]["map"]:
                ...
                self.FindWindowById(self.win["surface"]["color"]["const"]).SetColour(
                    color
                )
            self.SetMapObjUseMap(
                nvizType="surface", attrb="color", map=data["attribute"]["color"]["map"]
            )

        self.SetMapObjUseMap(
            nvizType="surface", attrb="shine", map=data["attribute"]["shine"]["map"]
        )
        value = data["attribute"]["shine"]["value"]
        if data["attribute"]["shine"]["map"]:
            self.FindWindowById(self.win["surface"]["shine"]["map"]).SetValue(value)
        else:
            self.FindWindowById(self.win["surface"]["shine"]["const"]).SetValue(
                self._getPercent(value)
            )
        if "transp" in data["attribute"]:
            ...
            if data["attribute"]["transp"]["map"]:
                ...
                self.FindWindowById(self.win["surface"]["transp"]["const"]).SetValue(
                    self._getPercent(value)
                )
            self.SetMapObjUseMap(
                nvizType="surface",
        ...
        for control, drawData in data["draw"].items():
            ...
            if control == "resolution":
                self.FindWindowById(self.win["surface"]["draw"]["res-coarse"]).SetValue(
                    drawData["coarse"]
                )
                self.FindWindowById(self.win["surface"]["draw"]["res-fine"]).SetValue(
                    drawData["fine"]
                )
                continue
    ...
    def UpdateVectorPage(self, layer, data, updateName=True):
        ...
        for v in ("lines", "points"):
            ...
            self.FindWindowById(self.win["vector"][v]["height"]["slider"]).Enable(
                enable
            )
    ...
    def UpdateVolumePage(self, layer, data, updateName=True):
        ...
        for control, idata in data["draw"].items():
            ...
            if control == "shading":
                if (
                    data["draw"]["shading"][data["draw"]["mode"]["desc"]]["desc"]
                    == "flat"
                ):
                    value = 0
                else:
        ...
        if "z" in data["position"]:
            ...
            for control in ("slider", "text"):
                self.FindWindowById(self.win["volume"]["position"][control]).SetValue(
                    zval
                )
        # set topo range
    ...
    def UpdateVolumeIsosurfPage(self, data):
        ...
        # set inout
        if "inout" in data:
            self.FindWindowById(self.win["volume"]["inout"]).SetValue(
                data["inout"]["value"]
            )
        ...
        if data:
            for coord in ("x1", "x2", "y1", "y2", "z1", "z2"):
                win = self.FindWindowById(
                    self.win["volume"]["slice"]["slider_" + coord]
                )
                win.Enable()
...
class PositionWindow(Window):
    ...
    def PostDraw(self):
        x, y = self.UpdatePos(self.data["position"]["x"], self.data["position"]["y"])
...
class ViewPositionWindow(PositionWindow):
    ...
    def __init__(self, parent, mapwindow, id=wx.ID_ANY, **kwargs):
        ...
        self.SetToolTip(_("Adjusts the distance and direction of the image viewpoint"))
