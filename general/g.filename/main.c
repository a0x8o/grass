...
>>>>>>> bd2fc8fa00 (wxpyimgview: explicit conversion to int (#2704))
=======
>>>>>>> 7e6543af68 (pygrass: Add update parameters method to Module (#1712))
=======
>>>>>>> 886d93287a (wxpyimgview: explicit conversion to int (#2704))
=======
>>>>>>> 590f9af9a9 (pygrass: Add update parameters method to Module (#1712))
=======
>>>>>>> 84913af40a (wxpyimgview: explicit conversion to int (#2704))
=======
>>>>>>> a34fd21516 (pygrass: Add update parameters method to Module (#1712))
=======
>>>>>>> c3e2c0c6ac (wxpyimgview: explicit conversion to int (#2704))
=======
>>>>>>> 1f48e2038f (pygrass: Add update parameters method to Module (#1712))
=======
>>>>>>> 8ac3ae1058 (wxpyimgview: explicit conversion to int (#2704))
=======
>>>>>>> ebe9fd0542 (pygrass: Add update parameters method to Module (#1712))
=======
>>>>>>> b41fbbe432 (wxpyimgview: explicit conversion to int (#2704))
=======
>>>>>>> 1695026431 (pygrass: Add update parameters method to Module (#1712))
=======
>>>>>>> 831293fa24 (wxpyimgview: explicit conversion to int (#2704))
=======
>>>>>>> ef9dc99cf3 (pygrass: Add update parameters method to Module (#1712))
=======
>>>>>>> 3ebc3e326d (wxpyimgview: explicit conversion to int (#2704))
=======
...
>>>>>>> 0758bb6a96 (pygrass: Add update parameters method to Module (#1712))
=======
>>>>>>> fa45e176f9 (pygrass: Add update parameters method to Module (#1712))
=======
>>>>>>> aa257e5504 (pygrass: Add update parameters method to Module (#1712))
=======
>>>>>>> 7ded4dd328 (pygrass: Add update parameters method to Module (#1712))
    /* Create element directory if requested and in current mapset. */
    if (flag_create) {
        if (strcmp(mapset, G_mapset()) != 0) {
            G_fatal_error("Cannot create <%s> (flag -%c):"
